    ...
    public static function getOne($id = '', $model = '', $map = [])
    {
        if ($model == '') {
            ...
            return Db::view($table, true)
               // ->view("cms_column", ['name' => 'column_name', 'list_template', 'detail_template'], 'cms_column.id='.$table.'.aid', 'left')
                ->view("cms_document", 'title,create_time', 'cms_document.id='.$table.'.aid', 'left')
               // ->view("cms_document", ['name' => 'create_time', 'title'], 'cms_column.id='.$table.'.aid', 'left')
                ->where($table.'.aid', $id)
                ->where($map)
                ->find();
        }
