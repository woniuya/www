...
CREATE TABLE `dp_cms_slider` (
  ...
  `status` tinyint(2) unsigned NOT NULL DEFAULT '0' COMMENT '状态',
  `ifwap` tinyint(2) unsigned NOT NULL DEFAULT '0' COMMENT '是否是pc',
  `ifapp` tinyint(2) unsigned NOT NULL DEFAULT '0' COMMENT '是否是App',
  `jumpid` tinyint(2) unsigned NOT NULL DEFAULT '6' COMMENT '跳转方式',
  `colomid` tinyint(2) unsigned NOT NULL DEFAULT '0' COMMENT '目标id',
  PRIMARY KEY (`id`)
